...
import (
	...
	cachev1alpha1 "github.com/nocturnalq/kubebuilder-memcached/api/v1alpha1"
)

// Definitions to manage status conditions
const (
	// typeAvailableMemcached represents the status of the Deployment reconcilation
...
// +kubebuilder:rbac:groups=cache.nocturnalq.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cache.nocturnalq.com,resources=memcacheds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=cache.nocturnalq.com,resources=memcacheds/finalizers,verbs=update
...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil && apierrors.IsNotFound(err) {
		...
		// Lets return the error for the reconcilation be re-trigged again
		return ctrl.Result{}, err
	}
